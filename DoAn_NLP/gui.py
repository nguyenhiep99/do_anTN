...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setStyleSheet("color: rgb(0, 2, 127);font: 13pt")
        ...
        self.lb_percent.setStyleSheet("color: rgb(0, 139, 0); font: 22pt")
        ...
        self.ip_predict = QtWidgets.QLineEdit(self.groupBox_2)
        self.ip_predict.setObjectName("ip_predict")
        self.gridLayout_3.addWidget(self.ip_predict, 0, 1, 1, 1)
        self.label_2 = QtWidgets.QLabel(self.groupBox_2)
        self.label_2.setObjectName("label_2")
        self.gridLayout_3.addWidget(self.label_2, 0, 0, 1, 1)
        self.lb_predict = QtWidgets.QLabel(self.groupBox_2)
        font = QtGui.QFont()
        font.setPointSize(22)
        self.lb_predict.setFont(font)
        self.lb_predict.setStyleSheet("color: rgb(0, 139, 0);font: 13pt")
        self.lb_predict.setText("")
        self.lb_predict.setAlignment(QtCore.Qt.AlignCenter)
        self.lb_predict.setObjectName("lb_predict")
        self.gridLayout_3.addWidget(self.lb_predict, 2, 1, 1, 1)
        self.cb_models_2 = QtWidgets.QComboBox(self.groupBox_2)
        self.cb_models_2.setObjectName("cb_models_2")
        self.cb_models_2.addItem("")
        self.cb_models_2.addItem("")
        self.gridLayout_3.addWidget(self.cb_models_2, 1, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btn_predict, 1, 2, 1, 1)
        ...
        self.ip_predict_path = QtWidgets.QLineEdit(self.groupBox)
        ...
        self.cb_models = QtWidgets.QComboBox(self.groupBox)
        self.cb_models.setObjectName("cb_models")
        self.cb_models.addItem("")
        self.cb_models.addItem("")
        self.gridLayout_6.addWidget(self.cb_models, 1, 1, 1, 1)
        self.btn_file_predict_path = QtWidgets.QPushButton(self.groupBox)
        ...
        self.btn_predict_file = QtWidgets.QPushButton(self.groupBox)
        ...
        # Tab2
        # predict text
        self.btn_predict.clicked.connect(self.predict_text)
        # predict file
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_train_path.setText(_translate("MainWindow", "Select"))
        self.btn_test_path.setText(_translate("MainWindow", "Select"))
        self.label.setText(_translate("MainWindow", "File train"))
        self.label_3.setText(_translate("MainWindow", "File Test"))
        ...
        self.gb_config_svm.setTitle(_translate("MainWindow", "Config SVM"))
        ...
        self.gb_config_nvb.setTitle(_translate("MainWindow", "Config Naive Bayes"))
        ...
        self.label_6.setText(_translate("MainWindow", "Config"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_1), _translate("MainWindow", "Train"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Predict text"))
        self.label_2.setText(_translate("MainWindow", "Text"))
        self.cb_models_2.setItemText(0, _translate("MainWindow", "NBC"))
        self.cb_models_2.setItemText(1, _translate("MainWindow", "SVM"))
        self.label_10.setText(_translate("MainWindow", "Model"))
        self.btn_predict.setText(_translate("MainWindow", "Predict"))
        self.groupBox.setTitle(_translate("MainWindow", "Predict file"))
        self.label_5.setText(_translate("MainWindow", "File predict"))
        ...
        self.btn_file_predict_path.setText(_translate("MainWindow", "Select"))
        self.btn_predict_file.setText(_translate("MainWindow", "Predict"))
    ...
    def train_model(self):
        ...
        result = "Accuracy Test:" + str(traning1(train_path, test_path,model_name, algorithm_index, algorithm_config))
    ...
    def predict_text(self):
        text = self.ip_predict.text()
        if (self.cb_models_2.currentIndex() == 0):
            model_name = 'NBC12' + '.pkl'
        if (self.cb_models_2.currentIndex() == 1):
            model_name = 'SVM12'+ '.pkl'
        self.lb_predict.setText(predict_text1(model_name, text))
    ...
    def predict_file(self):
        ...
        #
        self.lb_predict.setText(("trong file góp ý có " +str(k)+"đánh giá tích cực, " +str(l)+"đánh giá tiêu cực, "+str(l)+"đánh giá trung tính "))
